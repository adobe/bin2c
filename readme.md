...
Benchmarks Recorded on a i7-3520M CPU (2013) with 16GB Ram.
...
```
xxd_gcc                                 0.4823  Mb/s
xxd_clang                               0.6471  Mb/s
bin2c_gcc                              11.7460  Mb/s
bin2c_clang                            19.2711  Mb/s
compile_ld                            762.0250  Mb/s
```
...
```
bin2c_gcc                               11.746  Mb/s
bin2c_gcc_baseline                     12.1197  Mb/s
bin2c_clang                            19.2711  Mb/s
bin2c_clang_baseline                   21.5433  Mb/s
```
